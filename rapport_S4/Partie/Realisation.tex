...
\subsubsection{Achitecture du client}
	...
	~\\
	\item La fenêtre de localisation est un peu plus complexe. Pour l'utilisateur, les trois éléments importants sont : les informations concernant l'état du système, le bouton "rafraîchir" et le bouton "retour". 
	
	\end{itemize}		
	
\subsubsection{Détails concernant la fenêtre de localisation}

	La fenêtre de localistion 
